...
echo $this->CForm->input('cache_duration', array('label' => __d('core', 'Cache Duration'), 'label_info' => __d('core', 'This is used as a default setting and can be overriden by individual plugins.'), 'options' => array(
