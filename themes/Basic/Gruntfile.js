module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      ...
      css: {
        files: [
          {src: '.build/Assets/css/main.min.css', dest: 'webroot/css/main.min.css'},
          {src: '.build/Assets/css/main.css', dest: 'webroot/css/main.css'},
          {src: '.build/Assets/css/main.css.map', dest: 'webroot/css/main.css.map'}
        ]
      }
    },
